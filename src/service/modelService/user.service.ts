...
export class UserService {
  ...
  public async updateUser(user:User, uid: string) {
    return await this.afDatabese.list(this.PATH).update(uid.replace(/["]/g, '/'), {nome: user.nome, email: user.email, linha: user.linha});
  }
}
